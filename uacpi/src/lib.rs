...
pub struct UACPIApi {
  pub get_rsdp:
    unsafe fn( out_rsdp_address: *mut uacpi_phys_addr) -> uacpi_status,
  ...
  pub unmap: unsafe fn( addr: *mut ::core::ffi::c_void, len: uacpi_size),

  pub log: unsafe fn( arg1: uacpi_log_level, arg2: *const uacpi_char),
  ...
  pub pci_device_open: unsafe fn(
    address: uacpi_pci_address,
    out_handle: *mut uacpi_handle,
  ) -> uacpi_status,

  pub pci_device_close: unsafe fn( arg1: uacpi_handle),

  #[doc = " Read & write the configuration space of a previously open PCI device."]
  pub pci_read8: unsafe fn(
    device: uacpi_handle,
    offset: uacpi_size,
    value: *mut uacpi_u8,
  ) -> uacpi_status,

  pub pci_read16: unsafe fn(
    device: uacpi_handle,
    offset: uacpi_size,
    value: *mut uacpi_u16,
  ) -> uacpi_status,

  pub pci_read32: unsafe fn(
    device: uacpi_handle,
    offset: uacpi_size,
    value: *mut uacpi_u32,
  ) -> uacpi_status,

  pub pci_write8: unsafe fn(
    device: uacpi_handle,
    offset: uacpi_size,
    value: uacpi_u8,
  ) -> uacpi_status,

  pub pci_write16: unsafe fn(
    device: uacpi_handle,
    offset: uacpi_size,
    value: uacpi_u16,
  ) -> uacpi_status,

  pub pci_write32: unsafe fn(
    device: uacpi_handle,
    offset: uacpi_size,
    value: uacpi_u32,
  ) -> uacpi_status,
  ...
  pub io_map: unsafe fn(
    base: uacpi_io_addr,
    len: uacpi_size,
    out_handle: *mut uacpi_handle,
  ) -> uacpi_status,

  pub io_unmap: unsafe fn( handle: uacpi_handle),
  ...
  pub io_read8: unsafe fn(
    arg1: uacpi_handle,
    offset: uacpi_size,
    out_value: *mut uacpi_u8,
  ) -> uacpi_status,

  pub io_read16: unsafe fn(
    arg1: uacpi_handle,
    offset: uacpi_size,
    out_value: *mut uacpi_u16,
  ) -> uacpi_status,

  pub io_read32: unsafe fn(
    arg1: uacpi_handle,
    offset: uacpi_size,
    out_value: *mut uacpi_u32,
  ) -> uacpi_status,

  pub io_write8: unsafe fn(
    arg1: uacpi_handle,
    offset: uacpi_size,
    in_value: uacpi_u8,
  ) -> uacpi_status,

  pub io_write16: unsafe fn(
    arg1: uacpi_handle,
    offset: uacpi_size,
    in_value: uacpi_u16,
  ) -> uacpi_status,

  pub io_write32: unsafe fn(
    arg1: uacpi_handle,
    offset: uacpi_size,
    in_value: uacpi_u32,
  ) -> uacpi_status,
  ...
  pub alloc: unsafe fn( size: uacpi_size) -> *mut ::core::ffi::c_void,

  pub free: unsafe fn( mem: *mut ::core::ffi::c_void),

  #[doc = " Returns the number of nanosecond ticks elapsed since boot,\n strictly monotonic."]
  pub get_nanoseconds_since_boot: unsafe fn() -> uacpi_u64,

  #[doc = " Spin for N microseconds."]
  pub stall: unsafe fn( usec: uacpi_u8),

  #[doc = " Sleep for N milliseconds."]
  pub sleep: unsafe fn( msec: uacpi_u64),

  #[doc = " Create/free an opaque non-recursive kernel mutex object."]
  pub create_mutex: unsafe fn() -> uacpi_handle,

  pub free_mutex: unsafe fn( arg1: uacpi_handle),

  #[doc = " Create/free an opaque kernel (semaphore-like) event object."]
  pub create_event: unsafe fn() -> uacpi_handle,

  pub free_event: unsafe fn( arg1: uacpi_handle),

  #[doc = " Returns a unique identifier of the currently executing thread.\n\n The returned thread id cannot be UACPI_THREAD_ID_NONE."]
  pub get_thread_id: unsafe fn() -> uacpi_thread_id,
  ...
  pub disable_interrupts: unsafe fn() -> uacpi_interrupt_state,

  #[doc = " Restore the state of the interrupt flags to the kernel-defined value provided\n in 'state'."]
  pub restore_interrupts: unsafe fn( state: uacpi_interrupt_state),
  ...
  pub acquire_mutex:
    unsafe fn( arg1: uacpi_handle, arg2: uacpi_u16) -> uacpi_status,

  pub release_mutex: unsafe fn( arg1: uacpi_handle),

  #[doc = " Try to wait for an event (counter > 0) with a millisecond timeout.\n A timeout value of 0xFFFF implies infinite wait.\n\n The internal counter is decremented by 1 if wait was successful.\n\n A successful wait is indicated by returning UACPI_TRUE."]
  pub wait_for_event:
    unsafe fn( arg1: uacpi_handle, arg2: uacpi_u16) -> uacpi_bool,

  #[doc = " Signal the event object by incrementing its internal counter by 1.\n\n This function may be used in interrupt contexts."]
  pub signal_event: unsafe fn( arg1: uacpi_handle),

  #[doc = " Reset the event counter to 0."]
  pub reset_event: unsafe fn( arg1: uacpi_handle),

  #[doc = " Handle a firmware request.\n\n Currently either a Breakpoint or Fatal operators."]
  pub handle_firmware_request:
    unsafe fn( arg1: *mut uacpi_firmware_request) -> uacpi_status,
  ...
  pub install_interrupt_handler: unsafe fn(
    irq: uacpi_u32,
  ...
  pub uninstall_interrupt_handler: unsafe fn(
    arg1: uacpi_interrupt_handler,
    irq_handle: uacpi_handle,
  ) -> uacpi_status,

  #[doc = " Create/free a kernel spinlock object.\n\n Unlike other types of locks, spinlocks may be used in interrupt contexts."]
  pub create_spinlock: unsafe fn() -> uacpi_handle,

  pub free_spinlock: unsafe fn( arg1: uacpi_handle),
  ...
  pub lock_spinlock: unsafe fn( arg1: uacpi_handle) -> uacpi_cpu_flags,

  pub unlock_spinlock: unsafe fn( arg1: uacpi_handle, arg2: uacpi_cpu_flags),

  #[doc = " Schedules deferred work for execution.\n Might be invoked from an interrupt context."]
  pub schedule_work: unsafe fn(
  ...
  pub wait_for_work_completion: unsafe fn() -> uacpi_status,
}

static UACPI_API_PTR: AtomicPtr<UACPIApi> = AtomicPtr::null();

mod uacpi;

pub fn uacpi_load_api(api: &'static UACPIApi) {
  UACPI_API_PTR.store(api as *const _ as *mut _, core::sync::atomic::Ordering::Relaxed);
}
